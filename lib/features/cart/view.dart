        ...
        body: BlocConsumer<CartCubit, CartState>(
          ...
          builder: (context, state) {
            ...
            return state is GetOrderLoadingtState ||
                state is RomoveItemFromCardLoadingtState ||  state is  UpdateCardtLoadingtState
                ? const Center(
                        ...
                        return ContinerMyCart(
                          ...
                          removeitem: () {
                            CartCubit.get(context).romoveItem(
                                cartDetailsModel.data!.items![index].id!);
                          },
                          add: () {
                            setState(() {
                              cartDetailsModel
                              ...
                              CartCubit.get(context).updateCard(
                                  product_id: cartDetailsModel.data!
                                      .items![index].id!,
                          ...
                          image:
                          "${cartDetailsModel.data!.items![index].product!
                              .baseImage!.smallImageUrl}",
                          title:
                          "${cartDetailsModel.data!.items![index].product!
                              .name}",
                          price:
                          "${cartDetailsModel.data!.items![index]
                              .formatedBaseTotal}",
                          quantity: cartDetailsModel
                              .data!.items![index].quantity,
                        );
