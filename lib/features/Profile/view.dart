...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    print(token );
    return BlocProvider(
      create: (context) => ProfilCubit()..getProfil()..EditProfil,
      child: BlocConsumer<ProfilCubit, ProfilState>(
        ...
        builder: (context, state) {
          RegisterModrl? profilmodel = ProfilCubit
              .get(context)
              .myProfil;
          return state is ProfilLoadingtState?Center(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "${profilmodel!.data!.email}",                      style: AppTextStyles.boldtitles
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          InkWell(
                            onTap: () => navigateTo(context, AccountDetails(profilmodel: profilmodel,)),
                            child: Containedata(
